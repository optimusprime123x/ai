---
name: device-control
description: Control this device - flashlight on/off, volume up/down/mute, or open system settings screens (Wi-Fi, mobile data, Bluetooth, display, sound, battery, storage).
---
...
- parameters: A JSON string with the following fields:
  - screen: one of "wifi", "mobile_data", "bluetooth", "display", "sound", "battery", "storage", "location", "settings". String.
